...
export function buildCorrectionUserPrompt(
  ...
  return [
    ...
    "- Os arquivos acima mostram o ESTADO ATUAL apos as edicoes anteriores.",
    "- Analise os erros e gere edits CORRETIVOS sobre o estado atual.",
    '- O campo "search" DEVE corresponder ao ESTADO ATUAL dos arquivos (mostrado acima).',
    "- NAO repita edits que ja foram aplicados.",
    "- Corrija APENAS os erros indicados.",
    "- Se o erro for um import nao utilizado, remova-o.",
    "- Se o erro for um tipo incorreto, corrija a tipagem.",
